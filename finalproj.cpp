...
//USER INPUT
void readMenu(char& userChar, Knife knives[], int& size, bool& quit, UserData& ud, char userType[], char userSkin[], AllKnife& allKnives); //very important function that reads menu input and then executes their command
void buy(Knife knives[], UserData& ud, int& size, char userType[], char userSkin[], AllKnife& allKnives); //takes knives store front list and user data (removing from knife list)
void sell(Knife knives[], UserData& ud, int& size, char userType[], char userSkin[], AllKnife& allKnives); //takes knives store front list and user data (adds to knife list and user balance)
void trade(Knife knives[], UserData& ud, int& size, char userType[], char userSkin[], AllKnife& allKnives); //takes knives store front list and user data (swaps user knife for store front knife and adds balance)

//USER INPUT VALIDITY CHECKS
bool charValid(char userChar); //checks that the char is valid true if valid
bool readType(AllKnife& allKnives, char userType[], int& typeIndex); //read knife type from user and verifies it is valid
bool readSkin(AllKnife& allKnives, char userSkin[], int& skinIndex, int typeIndex); //read skin type from user and verifies it is valid
...
int main(){
  ...
  while(!quit){
    readMenu(userChar, knives, size, quit, ud, userType, userSkin, allKnives);
